...
export const GitHubStatsSection: React.FC = () => {
  ...
  return (
    <section id="github-stats" className="py-20 sm:py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      {/* Section Header */}
      <motion.div
      ...
      <motion.div
        ...
        transition={{ duration: 0.6 }}
        className="p-5 sm:p-8 rounded-3xl bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 space-y-6 sm:space-y-8"
      >
        {/* Username Header */}
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 pb-5 border-b border-black/10 dark:border-white/10">
          <div className="flex items-center gap-3">
            <div className="p-2.5 sm:p-3 rounded-2xl bg-[#16161C] text-white dark:bg-white/10 shrink-0">
              <Github className="w-5 h-5 sm:w-6 sm:h-6" />
            </div>
            <div>
              <h3 className="font-heading font-bold text-base sm:text-lg text-[#16161C] dark:text-[#FBFAF7]">
                @{username}
              </h3>
              <p className="text-[11px] sm:text-xs font-mono text-[#16161C]/60 dark:text-[#FBFAF7]/60">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            <input
              ...
              className="px-3.5 py-2 rounded-xl bg-white dark:bg-black/40 border border-black/10 dark:border-white/15 text-xs font-mono text-[#16161C] dark:text-[#FBFAF7] focus:outline-none focus:ring-2 focus:ring-[#1B4DFF] flex-1 sm:w-52 min-h-[40px]"
            />
            <a
              ...
              className="p-2.5 rounded-xl bg-[#1B4DFF] text-white hover:bg-[#1230B3] transition-colors shrink-0 min-h-[40px] min-w-[40px] flex items-center justify-center"
            >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
          <div className="p-3.5 sm:p-4 rounded-2xl bg-white/60 dark:bg-black/30 border border-black/5 dark:border-white/10">
            <div className="flex items-center gap-1.5 text-[11px] sm:text-xs font-mono text-[#16161C]/60 dark:text-[#FBFAF7]/60 mb-1">
              <GitCommit className="w-3.5 h-3.5 text-[#00C48C] shrink-0" />
              <span>Commits</span>
            </div>
          ...
          <div className="p-3.5 sm:p-4 rounded-2xl bg-white/60 dark:bg-black/30 border border-black/5 dark:border-white/10">
            <div className="flex items-center gap-1.5 text-[11px] sm:text-xs font-mono text-[#16161C]/60 dark:text-[#FBFAF7]/60 mb-1">
              <Code2 className="w-3.5 h-3.5 text-[#1B4DFF] shrink-0" />
              <span>Repos</span>
            </div>
            <p className="font-heading text-2xl sm:text-3xl font-extrabold text-[#16161C] dark:text-[#FBFAF7]">
          ...
          <div className="p-3.5 sm:p-4 rounded-2xl bg-white/60 dark:bg-black/30 border border-black/5 dark:border-white/10">
            <div className="flex items-center gap-1.5 text-[11px] sm:text-xs font-mono text-[#16161C]/60 dark:text-[#FBFAF7]/60 mb-1">
              <Star className="w-3.5 h-3.5 text-[#FF5A1F] shrink-0" />
              <span>Stars</span>
            </div>
            <p className="font-heading text-2xl sm:text-3xl font-extrabold text-[#16161C] dark:text-[#FBFAF7]">
        ...
        {/* Contribution Heatmap with Horizontal Scroll for Mobile */}
        <div className="space-y-3">
          <div className="flex items-center justify-between text-[11px] sm:text-xs font-mono text-[#16161C]/70 dark:text-[#FBFAF7]/70">
            <span>Contribution Activity Grid <span className="text-[10px] opacity-60 sm:hidden">(swipe)</span></span>
            <div className="flex items-center gap-1 sm:gap-1.5 text-[10px]">
              <span>Less</span>
          ...
          <div className="p-3 sm:p-4 rounded-2xl bg-white/60 dark:bg-black/40 border border-black/5 dark:border-white/10 overflow-x-auto">
        ...
        <div className="space-y-3 pt-2">
          ...
          <div className="flex flex-wrap gap-3 sm:gap-4 pt-1">
            {gitHubStatsData.topLanguages.map((lang) => (
              <div key={lang.name} className="flex items-center gap-1.5 text-[11px] sm:text-xs font-mono text-[#16161C]/80 dark:text-[#FBFAF7]/80">
                <span
